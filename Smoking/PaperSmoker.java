...
public class PaperSmoker implements Callable<Boolean>
{
  ...
  private final Cigarette m_matches;
	...
	public PaperSmoker(String name, Supplier supplier, Cigarette paper, Cigarette tobacco, Cigarette matches)
	{
    m_paper = paper;
    m_tobacco = tobacco;
    m_matches = matches;
